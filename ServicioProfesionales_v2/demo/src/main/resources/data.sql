...
--('La Plata', 1), ('San Fernando del Valle', 2), ('Resistencia', 3), ('Rawson', 4), ('Córdoba Capital', 5),
--('Corrientes Capital', 6), ('Paraná', 7), ('Formosa Capital', 8), ('San Salvador de Jujuy', 9), ('Santa Rosa', 10),
--('La Rioja Capital', 11), ('Mendoza Capital', 12), ('Posadas', 13), ('Neuquén Capital', 14), ('Viedma', 15),
--('Salta Capital', 16), ('San Juan Capital', 17), ('San Luis Capital', 18), ('Río Gallegos', 19), ('Santa Fe Capital', 20),
--('Santiago del Estero Capital', 21), ('Ushuaia', 22), ('San Miguel de Tucumán', 23), ('CABA', 24);
...
('Kinesiología', 'Tratamiento físico y rehabilitación'),
('Fonoaudiología', 'Trastornos del habla y audición'),
...
('Psicomotricidad', 'Desarrollo corporal y emocional');
...
INSERT INTO ESPECIALIDAD_PROFESIONAL (profesional_id, especialidad_id, matricula) VALUES
(1, 1, 'MAT-001'), -- Cardiología
(1, 3, 'MAT-002'), -- Kinesiología
(1, 6, 'MAT-003'); -- Psicología
