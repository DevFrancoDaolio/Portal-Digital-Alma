...
export default function ClinicProfessionals() {
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            ...
            try {
                ...
                setProfessionals(profesionalesRes.data || [])
                setEspecialidades(especialidadesRes.data || [])
            } catch (error) {
                console.error("Error al cargar datos:", error)
                alert("Error al cargar profesionales o especialidades")
            } finally {
                setLoading(false)
            }
        }
    ...
    const handleGuardarEdicion = () => {
        ...
        getProfesionales()
            ...
            .catch((err) => console.error("Error al recargar profesionales:", err))
    }
